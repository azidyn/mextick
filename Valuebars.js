    ...
    newtick( tick ) {
        ...
        if ( total > this.resolution ) {
            ...
            this.agg = {
                ...
                timestamp: tick.timestamp,      // For the timestamp, which is now variable, just use the tick timestamp of the first trade in this new value bar
                open: lc,
                high: tick.price,
                low: tick.price,
                close: tick.price,
                value: nextstart                // Initialize next value bar with overflow from previous bar
            };
